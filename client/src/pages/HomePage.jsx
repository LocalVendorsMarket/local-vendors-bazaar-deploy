...
const HomePage = ({ cart, setCart }) => {
  ...
  const cardStyle = { minWidth: "250px", backgroundColor: "#fff", padding: "1rem", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)" };
  const imageStyle = { width: "100%", height: "180px", objectFit: "cover", borderRadius: "8px" };

  return (
    <div style={{ fontFamily: "sans-serif", backgroundColor: "#e6f0ff", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      {/* TODO: Reinsert Full NavBar, SubNavBar, Banner, Modals, Footer Here */}
