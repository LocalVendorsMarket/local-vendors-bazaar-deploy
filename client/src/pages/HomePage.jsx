...
const HomePage = ({ cart, setCart }) => {
  ...
  const allProducts = [
    { id: 1, name: 'Organic Lip Balm', category: 'Health & Beauty', price: '$12', rating: '⭐⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Lip+Balm' },
    { id: 2, name: 'Handmade Necklace', category: 'Jewelry', price: '$25', rating: '⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Necklace' },
    { id: 3, name: 'Embroidered Kurti', category: 'Clothing', price: '$30', rating: '⭐⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Kurti' },
    { id: 4, name: 'Natural Foundation', category: 'Health & Beauty', price: '$20', rating: '⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Foundation' },
    { id: 5, name: 'Custom Artwork', category: 'Art', price: '$80', rating: '⭐⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Artwork' },
    { id: 6, name: 'Local Honey', category: 'Food', price: '$12', rating: '⭐⭐⭐⭐⭐', image: 'https://via.placeholder.com/300x200?text=Local+Honey' }
  ];
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', backgroundColor: '#e6f0ff' }}>
      {/* Nav Bar */}
      <header style={{ backgroundColor: '#003366', color: 'white', display: 'flex', flexWrap: 'wrap', alignItems: 'center', padding: '1rem' }}>
      ...
      {/* Banner */}
      <div style={{ backgroundColor: '#003366', color: 'white', textAlign: 'center', padding: '2rem 1rem', margin: '1rem 0' }}>
        <h1 style={{ margin: 0 }}>Promote your products and services. Get visibility. Join Local Vendors Bazaar today.</h1>
      </div>
