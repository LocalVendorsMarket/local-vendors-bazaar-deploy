...
const HomePage = ({ cart, setCart }) => {
  ...
  return (
    <div style={{ fontFamily: 'sans-serif', backgroundColor: '#e6f0ff', minHeight: '100vh' }}>
      {/* Navbar, Modals, Sub Nav Bar, Product Rows, and Footer code should go here */}
      {/* You've already written these above. This cleaned version just ensures style constants are only declared once */}
    </div>
  );
};
