          ...
          <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSignInSubmit}>
              <input
                ...
                required
                style={{ padding: '10px', borderRadius: '6px', width: '250px', fontSize: '16px', marginBottom: '10px' }}
              />
              <div>
                <button type="submit" style={{ marginRight: '10px', padding: '0.5rem 1rem', backgroundColor: '#003366', color: 'white', borderRadius: '6px', cursor: 'pointer' }}>
                  {isNewCustomer ? 'Sign Up' : 'Sign In'}
                </button>
                <button onClick={() => setIsNewCustomer(!isNewCustomer)} style={{ marginRight: '10px', padding: '0.5rem 1rem', backgroundColor: '#ccc', borderRadius: '6px', cursor: 'pointer' }}>
                  {isNewCustomer ? 'Back to Sign In' : 'New Customer?'}
                </button>
                <button onClick={() => setIsSignInModalOpen(false)} style={{ padding: '0.5rem 1rem', backgroundColor: '#aaa', borderRadius: '6px', cursor: 'pointer' }}>Cancel</button>
              </div>
            </form>
          </div>
        </div>
