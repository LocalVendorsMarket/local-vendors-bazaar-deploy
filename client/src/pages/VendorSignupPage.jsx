...
const VendorSignupPage = ({ cart }) => {
  return (
    <div style={{ fontFamily: 'sans-serif', backgroundColor: '#f9f9f9', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: '#003366', color: 'white', padding: '1.5rem', marginTop: '2rem', textAlign: 'center' }}>
...
// Styles
const navLinkStyle = { margin: '0 10px', color: '#fff', textDecoration: 'none', fontSize: '14px' };
const inputBox = { width: '100%', padding: '0.75rem', borderRadius: '8px', border: '1px solid #ccc', fontSize: '1rem' };
const submitButtonStyle = { backgroundColor: '#2b9348', color: '#fff', padding: '0.75rem', border: 'none', borderRadius: '8px', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer' };
