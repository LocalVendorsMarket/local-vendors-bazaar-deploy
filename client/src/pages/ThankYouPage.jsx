...
const ThankYouPage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-8">
      <NavigationBar />
      <h1 className="text-5xl font-extrabold text-green-600 mt-20 mb-6">🎉 Thank You!</h1>
      <p className="text-gray-600 text-lg mb-8 text-center max-w-2xl">
        Your application has been submitted successfully. We’ll review and get back to you soon!
      </p>
      <Link
        to="/shop"
